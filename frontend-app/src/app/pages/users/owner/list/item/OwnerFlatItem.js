...
const OwnerFlatItem = (props) => {
    ...
    usePreloadPRO3(loadFlatHasImageUrl, `api/flats/flat_has_image/${props.ownerHasFlat.flatId}`, LOAD_FLAT_HAS_IMAGE_URL, props.ownerHasFlat.flatId);
    usePreloadPRO(loadData, `api/flats/flat_data/${props.ownerHasFlat.flatId}`, LOAD_FLAT_DATA_BY_ID);
