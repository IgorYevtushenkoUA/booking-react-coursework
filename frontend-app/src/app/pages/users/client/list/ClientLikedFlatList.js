...
import {
    LOAD_CLIENT_LIKED_FLATS_DATA,
    LOAD_CLIENT_LIKED_FLATS_IMAGES,
    LOAD_CLIENT_LIKED_FLATS_IMAGES_URL,
    loadClientLikedFlatImageURL,
    loadData,
...
const ClientLikedFlatList = (props) => {
    ...
    usePreloadPRO3(loadClientLikedFlatImageURL, `api/flats/flat/${accountId}`, LOAD_CLIENT_LIKED_FLATS_IMAGES_URL, accountId);
